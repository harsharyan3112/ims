...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed By Harsh $ Rajat")
        self.root.geometry("1350x700+250+200")
        ...
        btn_login=Button(login_frame,command=self.login,text="Log In",font=("Arial Round MT Bold",15),bg="#00B0F0",activebackground="#00B0F0",fg="white",activeforeground="white",cursor="hand2").place(x=50,y=300,width=250,height=35)
        ...
        lbl_reg=Label(register_frame,text="Have an issue ?",font=("times new roman",11),bg="white").place(x=70,y=15)
        btn_contact=Button(register_frame,text="Contact",font=("times new roman",11,"bold"),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E").place(x=200,y=14)
...
#--------------------------------functions------------------------
    ...
    def animate(self):
        ...
        self.lbl_change_image.after(1200,self.animate)
            ...
            if self.employee_id.get()=="":
                ...
                if email==None:
                   ...
                   if chk!='s':
                    ...
                    lbl_c_pass=Label(self.forget_win,text="Confirm Password",font=("times new roman",15)).place(x=20,y=60)
    ...
    def update_password(self):
        if self.var_new_pass.get()=="" or self.var_conf_pass.get()=="":
            ...
            try:
                ...
                con.commit()
                messagebox.showinfo("Success","Password updated successfull",parent=self.forget_win)
    ...
    def send_email(self,to_):
        ...
        self.otp=time.str(time.strftime("%H%M%S"))+str(time.strftime("%S"))
